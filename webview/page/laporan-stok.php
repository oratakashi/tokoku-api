                        ...
                        <form role="form" name="period" action="" method="POST">
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control pull-left" name="cari" <?php if (!empty($_POST['cari'])) {
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="text-align:right;">
                                            <b>Rp. <?php echo number_format($data['harga_per']); ?></b>
                                            <br>Rp. <?php echo number_format($stokdin * $data['harga_per']); ?>
                                        </td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" style="text-align:right">
                                        <h2><b><?php echo number_format($sumjum); ?></b></h2>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
